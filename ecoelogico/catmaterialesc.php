...
<head>
    ...
    <title>Material Escolar - Eco é Lógico</title>
  ...
  <script>
    ...
    <header class="bg-verdec wrapper">
          ...
          <ul class=" navbar-nav mr-auto">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item let-verde" href="catjoias.php">Jóias</a>
            ...
            <li class="nav-item ">
              <a class="nav-link disabled dicas" href="dicas.html">Dicas</a>
            </li>
            <li class="nav-item ">
              <a class="nav-link disabled dicas" href="minhaloja.php">Minha loja</a>
            </li>
          </ul>
      ...
      <a href="pagelogin.html"><button type="button" class="btn-perfil"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-person-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="margin-bottom: 4px;">
       ...
       <?php 
        $sql="SELECT * FROM tbl_produto WHERE id_categoria=7 ORDER BY id_produto DESC";
